...
-- HechoVenta
--
INSERT INTO [AlbarranDW].[dbo].[HechoVenta]
SELECT 
...
--
INSERT INTO [AlbarranDW].[dbo].[DimensionDetalleVenta] 
SELECT 
 [pr].[nombre] AS [NombreDeProducto]
,[pr].[precio] AS [PrecioUnitario]
,[dv].[cantidad] AS [CantidadDeProducto]
