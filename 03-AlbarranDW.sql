...
-- AlbarranDW.dbo.DimensionCliente definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.DimensionCliente;

CREATE TABLE AlbarranDW.dbo.DimensionCliente (
...
-- AlbarranDW.dbo.DimensionEmpleado definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.DimensionEmpleado;

CREATE TABLE AlbarranDW.dbo.DimensionEmpleado (
...
-- AlbarranDW.dbo.DimensionTiempo definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.DimensionTiempo;

CREATE TABLE AlbarranDW.dbo.DimensionTiempo (
...
-- AlbarranDW.dbo.DimensionSucursal definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.DimensionSucursal;

CREATE TABLE AlbarranDW.dbo.DimensionSucursal (
...
-- AlbarranDW.dbo.HechoVenta definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.HechoVenta;

CREATE TABLE AlbarranDW.dbo.HechoVenta (
...
-- AlbarranDW.dbo.DimensionDetalleVenta definition

-- Drop table

-- DROP TABLE AlbarranDW.dbo.DimensionDetalleVenta;

CREATE TABLE AlbarranDW.dbo.DimensionDetalleVenta (
